...
function ELMSButtonCard() {
    ...
    return (
        <div
            onClick={openELMS}
            className="gradientButton w-60 text-white rounded-2xl cursor-pointer hover:opacity-90 transition pt-4 pb-10 flex items-center my-2"
        >
            <div className="flex flex-col justify-center w-full px-4 -pt-10 gap-2">
                ...
                <p className="montserrat font-semibold text-[17px]">
                    Go to STI Elms
                </p>
