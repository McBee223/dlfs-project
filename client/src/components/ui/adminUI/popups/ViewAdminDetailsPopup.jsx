...
function ViewAdminDetailsPopup({ onClose, admin, onUpdate, readOnly = false }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div ref={modalRef} className="montserrat bg-white rounded-2xl shadow-lg p-6 w-100">

                <div className="flex justify-between items-center mb-5">
                    <h2 className="text-[#323232] text-xl font-semibold">Admin Details</h2>
                ...
                <div className="flex flex-col">
                    <div className="flex gap-2">
                        <div className="flex-1">
                            <label className="text-xs text-[#000000] font-semibold mb-1 block">First Name</label>
                            <input
                                type="text"
                                value={firstName}
                        ...
                        <div className="flex-1">
                            <label className="text-xs text-[#000000] font-semibold mb-1 block">Last Name</label>
                            <input
                                type="text"
                                value={lastName}
                    ...
                    <div>
                        <label className="text-xs text-[#000000] font-semibold mb-1 block">Admin ID</label>
                        <input
                            type="text"
                            value={adminId}
                    ...
                    <div>
                        <label className="text-xs text-[#000000] font-semibold mb-1 block">Microsoft Account</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="text-xs text-[#000000] font-semibold mb-1 block">User Level</label>
                        <input
                            type="text"
                            value={userLevel}
                            disabled
