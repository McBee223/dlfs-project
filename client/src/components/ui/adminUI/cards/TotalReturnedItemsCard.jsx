    ...
    return (
        <div
            ...
            <div className="flex items-center justify-between">
                <div className="w-17 h-17 2xl:w-20 2xl:h-20 rounded-lg flex items-center justify-center bg-[#FFE8E8]">
                    <img src={TotalReturnedItemsIcon} alt="" className="w-10 h-10 2xl:w-12 2xl:h-12" />
                </div>
            </div>
            <div>
                <p className="text-sm 2xl:text-base text-[#646464] font-semibold mt-3">Total Returned Items</p>
                <p className="text-3xl 2xl:text-4xl font-semibold text-[#AF2C04]">{count}</p>
            </div>
        </div>
    );
}
