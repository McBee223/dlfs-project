    ...
    return (
        ...
        >
            <div className="flex items-center justify-between">
                <div className="w-17 h-17 rounded-lg flex items-center justify-center bg-[#E8FFE9]">
                    <img src={TotalUsersIcon} alt="" className="w-10 h-10" />
                </div>
            </div>
            <div>
                <p className="text-sm text-[#646464] font-semibold mt-3">Total Users</p>
                <p className="text-3xl font-semibold text-[#04AF0A]">{totalUsers}</p>
            </div>
        </div>
    );
}
