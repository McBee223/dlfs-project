...
function AboutUsSection() {
    ...
    return (
        <section className="w-full h-fit py-24 2xl:py-32 bg-white">

            <div className="relative z-20 w-full max-w-7xl 2xl:max-w-7xl mx-auto px-15 grid grid-cols-2 items-center">

                <div className="col-span-2 flex flex-col items-center text-center">

                    <h2 className="montserrat text-6xl 2xl:text-[83px] w-300 text-[#323232] font-semibold mb-4">
                        Turning Lost Into Found
                    </h2>

                    <p className="montserrat max-w-3xl 2xl:max-w-5xl text-sm 2xl:text-lg text-[#646464] leading-relaxed">
                    ...
                    <img src={AboutUseImage} alt="" className="w-225 2xl:w-325" />
